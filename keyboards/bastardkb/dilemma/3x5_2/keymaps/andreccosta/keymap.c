...
#define _______________DEAD_HALF_ROW_L_____________ KC_ESC, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
...
#define LAYOUT_LAYER_FUNCTION                                                                 \
    _______________DEAD_HALF_ROW_L_____________, KC_PSCR,   KC_F7,   KC_F8,   KC_F9,  KC_F12, \
...
#define LAYOUT_LAYER_POINTER                                                                  \
    XXXXXXX, XXXXXXX,    KC_Q, DPI_RMOD, DPI_MOD, S_D_RMOD, S_D_MOD,    KC_X, XXXXXXX, XXXXXXX, \
...
#define LAYOUT_LAYER_NAVIGATION                                                               \
    _______________DEAD_HALF_ROW_L_____________, _______________DEAD_HALF_ROW_______________, \
